...
class classification_model():
  ...
  def performance_multi_thr(self, thresholds_priori_list = None, simulation_name = None, pos_label = '1' ):
    """
    ...
    for i, threshold_priori_id, in enumerate(thresholds_priori_list.keys()):
        ...
        # print(threshold)
        # print(priori)
        self.performance(simulation_name=simulation_name, threshold = threshold, priori = priori, pos_label = pos_label, threshold_priori_id = threshold_priori_id)
  ...
  def map_quantile_threshold(simulation_name, model_name, label_to_map = '1', quantiles = [0.5], set_type = 'test'):
    """
...
# Praca zdalna mi doskwiera, ciągłe siedzenie w domu coraz bardziej uwiera.  Jednak nie trace nadziej że to się wkrótce zmieni. I znowu wszyscy razem pod jednym dachem będziemy wspólnie wesoło sprintować. 
